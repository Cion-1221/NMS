...
const TabSubnetTree: React.FC = () => {
  ...
  // ── Reload a single root's subtree ───────────────────────────────────────────
  ...
  const columns: ColumnsType<UINode> = [
    ...
    {
      title: t('common.actions'), key: 'action', width: 230,
  ...
  const visibleData = searchText ? filterTree(treeData, searchText.trim()) : treeData;
    ...
    <div>
      ...
      >
        <Form form={splitForm} layout="vertical">
          ...
          <Form.Item
            name="target_bits" label={t('ipam.subnet.targetMask')}
