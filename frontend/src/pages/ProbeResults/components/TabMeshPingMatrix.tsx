          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
            {cell.v4 && renderProto(
              ...
              cell.v4.target_ip
                ...
                : undefined,
              cell.v4.target_ip
                ? <LatencySpark agentId={row.agent_id} target={cell.v4.target_ip} type="meshping" reportedAt={cell.v4.reported_at} />
                : undefined,
            )}
            {cell.v6 && renderProto(
              cell.v6,
              ...
              cell.v6.target_ip
                ...
                : undefined,
              cell.v6.target_ip
                ? <LatencySpark agentId={row.agent_id} target={cell.v6.target_ip} type="meshping" reportedAt={cell.v6.reported_at} />
                : undefined,
            )}
          </div>
        );
